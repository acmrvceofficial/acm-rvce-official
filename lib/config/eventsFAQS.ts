...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "Visit our membership page at /join for the complete process. You'll need an ACM Global Student Membership and then register with our RVCE chapter. Membership is open to all RVCE students.",
  },
  {
