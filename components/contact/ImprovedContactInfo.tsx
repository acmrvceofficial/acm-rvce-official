                  ...
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.link ? (
                        ...
                        <p className="text-sm sm:text-base text-foreground font-medium leading-relaxed whitespace-pre-line">
                          {item.value}
                        </p>
                      )}
                    </div>
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  {items.find((item) => item.label === "Address")?.value ||
                    "R.V. College of Engineering, Mysore Road, Bengaluru, Karnataka 560059"}
                </p>
                <a
                  href={
                    items.find((item) => item.label === "Address")?.link ||
                    "https://maps.google.com/?q=R.V.+College+of+Engineering"
                  }
                  target="_blank"
                  rel="noopener noreferrer"
