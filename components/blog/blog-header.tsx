  ...
  return (
    <div className="py-12 md:py-16">
      <div className="mx-auto max-w-3xl text-center">
        <h1 className="font-heading text-4xl font-bold tracking-tighter text-foreground sm:text-5xl md:text-6xl my-8 lg:text-7xl">
          {title}
        </h1>
      ...
      <div className="mx-auto mt-10 max-w-xl flex flex-col gap-4 md:max-w-2xl md:flex-row md:gap-2 md:items-center">
        ...
        <form 
          ...
          className="flex w-full items-center gap-2 rounded-full border bg-background/50 p-1.5 backdrop-blur-sm shadow-sm sm:p-2 md:w-auto" /* Added md:w-auto */
        >
